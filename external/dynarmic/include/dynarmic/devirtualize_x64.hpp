...
template<auto mfp>
DevirtualizedCall DevirtualizeGeneric(mcl::class_type<decltype(mfp)>* this_) {
    return DevirtualizedCall{&impl::ThunkBuilder<decltype(mfp), mfp>::Thunk, reinterpret_cast<u64>(this_)};
}
